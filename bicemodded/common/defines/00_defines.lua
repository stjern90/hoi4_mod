...
NNavy = {
	...
	COMBAT_ESCAPING_SPEED_BALANCE = 0.25,							-- DNM, original 0.8, should make it a little easier for disengaging ships to escape -- Same as above, but used to balance when escaping.
...
NAI = {
	...
	ATTACK_HEAVILY_DEFENDED_LIMIT = 0.02,				-- AI will not launch attacks against heavily defended fronts unless they consider to have this level of advantage (1.0 = 100%)
