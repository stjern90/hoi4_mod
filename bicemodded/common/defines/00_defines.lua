...
NNavy = {
	...
	COMBAT_DETECTED_CONVOYS_FROM_SURFACE_DETECTION_STAT = 0.2,		-- Each 1.0 of surface_detection that ship has (equipment stat), gives x% of convoys discovered from total travelling along the route.
	...
	NAVAL_COMBAT_RESULT_TIMEOUT_YEARS = 3,							-- after that many years, we clear the naval combat results, so they don't get stuck forever in the memory.
