...
NAir = {
	...
	CLOSE_AIR_SUPPORT_EXPERIENCE_SCALE = 0.0003,			-- How much the experinence gained by CAS is scaled
...
NNavy = {
	...
	EXPERIENCE_FACTOR_CONVOY_ATTACK = 2,							-- DNM, original 0.05, increased because sub XP gain very slow.
