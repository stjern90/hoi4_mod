...
NGame = {
	...
	GAME_SPEED_SECONDS = { 0.75, 0.25, 0.15, 0.1, 0.0 }, -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NDiplomacy = {
	...
	TENSION_CIVIL_WAR_IMPACT = 0.15,					-- civil war multiplier on tension.
	TENSION_NO_CB_WAR = 8,							-- Amount of tension generated by a no-CB war
	...
	TENSION_ANNEX_CLAIM = 1.0,						-- Amount of tension generated by annexing a state you DO have claims on
	TENSION_ANNEX_CORE = 0.5,							-- Amount of tension generated by annexing a state that is your core
	TENSION_PUPPET = 1.1,								-- Amount of tension generated by puppeting (per state)
	TENSION_VOLUNTEER_FORCE_DIVISION = 0.3,			-- Amount of tension generated for each sent division
	TENSION_DECAY = 0.15,							-- Each months tension decays this much
	...
	TENSION_PEACE_FACTOR = 0.35,						-- scale of the amount of tension (from war declaration) reduced when peace is completed.
	TENSION_LIBERATE = -2,							-- Amount of tension generated by liberating a country. 
	TENSION_CAPITULATE = 0.5,						-- Scale of the amount of tension created by a countries capitulation.
...
NCountry = {
	...
	RESISTANCE_STRENGTH_FROM_NEIGHBORS = 0.05, 		-- Multiplies how much resistance can spread from one state to its neighbors, a state will spread whatever is highest of its victorypoints resistance increase or half of any of its neighbors spread, multiplied by this
	...
	DEFAULT_WAR_SUPPORT = 0.30,						-- Default war support if not scripted otherwise.
	...
	WAR_SUPPORT_DEFENSIVE_WAR = 0.05,				-- Impact of being in defensive war
...
NResistance = {
	...
	RESISTANCE_TARGET_MODIFIER_OCCUPIED_CAPITULATED = 4.0, -- resistance target modifier when the enemy is capitulated
	...
	COMPLIANCE_GROWTH_BASE = 0.074, -- base compliance grow
	...
	COMPLIANCE_GROWTH_HAS_CLAIM = 8, -- compliance growth buff if state has a claim
	...
	COMPLIANCE_DECAY_PER_EXILE_LEGITIMACY = -0.008, -- higher legitimacy will give higher decay to compliance
	
	RESISTANCE_RATIO_DIFF_TO_SPREAD = 0.30, -- resistance diff between two neighbour states will spread by this ratio ( from highest resistance states to lower ones and it will only spread once to a state)
...
NProduction = {
	...
	MIN_POSSIBLE_TRAINING_MANPOWER = 40000,	-- How many deployment lines minimum can be training
...
NAir = {
	...
	AIR_WING_BOMB_DAMAGE_FACTOR = 1.5,					-- Used to balance the damage done while bombing.
...
NNavy = {
	...
	CONVOY_DEFENSE_MAX_CONVOY_TO_SHIP_RATIO							= 9.0,		-- each ship in convoy defense mission can at most cover this many convoys without losing efficiency
...
NAI = {
	...
	RESEARCH_AHEAD_OF_TIME_FACTOR = 5.5, 		-- To which extent AI should care about ahead of time penalties to research
	...
	PRODUCTION_MAX_PROGRESS_TO_SWITCH_NAVAL = 0.3,		-- AI will not replace ships being built by newer types if progress is above this
...
NOperatives = {
	...
	OPERATIVE_BASE_BOOST_IDEOLOGY = 0.12,					-- Base amount of daily ideology drift provoked by an operative
...
NIntel = {
	...
	CIVILIAN_INTEL_NEEDED_TO_SHOW_CURRENT_FOCUS = 0.15,  -- min required intel to show currently focus
