...
NCountry = {
	...
	REINFORCEMENT_DELIVERY_SPEED_MIN = 0.50,			-- The distance from the supply region to capital should affect the speed only a little bit. Main factor for penalty is overcrowded areas, and not the route length.
...
NBuildings = {
	...
	SUPPLY_PORT_LEVEL_THROUGHPUT = 6.8,   -- supply throughput per level of naval base
	INFRA_TO_SUPPLY = 2.65,              -- to mitigate lowered supply by the new modifiers
...
NMilitary = {
	...
	RETREAT_SPEED_FACTOR = 0.33,                    -- speed bonus when retreating
	WITHDRAWING_SPEED_FACTOR = 0.23,				-- speed bonus when withdrawing
...
NNavy = {
	...
	COMBAT_DAMAGE_REDUCTION_ON_RETREAT = 0.7,						-- Retreating ships are using their rear cannons, so the damage should be reduced.
	NAVY_MAX_XP = 160,
	...
	SUBMARINE_HIDE_TIMEOUT = 14,										-- Amount of in-game-hours that takes the submarine (with position unrevealed), to hide.
...
NAI = {
	...
	UPGRADE_DIVISION_RELUCTANCE = 2,					-- How often to consider upgrading to new templates for units in the field
