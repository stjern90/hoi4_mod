...
NAI = {
	...
	TRADEABLE_FACTORIES_FRACTION = 0.5,			-- Will at most trade away this fraction of factories.
	...
	STOP_TRAINING_EQUIPMENT_LEVEL = 0.96,                -- ai will not train if equipment drops below this level
