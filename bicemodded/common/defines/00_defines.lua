...
NDiplomacy = {
	...
	TENSION_ANNEX_NO_CLAIM = 2.2,						-- Amount of tension generated by annexing a state you don't have claims on
	TENSION_ANNEX_CLAIM = 1.5,						-- Amount of tension generated by annexing a state you DO have claims on
	TENSION_ANNEX_CORE = 0.8,							-- Amount of tension generated by annexing a state that is your core
	TENSION_PUPPET = 1.0,								-- Amount of tension generated by puppeting (per state)
	...
	BASE_CONDITIONAL_PEACE_MONTHS = 4,				-- War length must be before a surrender i possible.
...
NNavy = {
	...
	SEA_AIR_COMBAT_MAX_WINGS_ON_STACK =  280,                       -- DNM original 200 -- how many attacker planes can enter naval comabt per wave
