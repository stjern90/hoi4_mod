...
NCountry = {
	...
	VP_TO_SUPPLY_BONUS_CONVERSION = 3.2,			-- Bonus to supply local supplies from Victory Points, multiplied by this aspect and rounded to closest integer
...
NBuildings = {
	...
	INFRA_TO_SUPPLY = 1.25,              -- to mitigate lowered supply by the new modifiers
