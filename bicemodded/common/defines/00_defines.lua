...
NMilitary = {
	...
	LAND_COMBAT_STR_ARMOR_ON_SOFT_DICE_SIZE = 0,   -- extra damage dice if our armor outclasses enemy
...
NAir = {
	...
	ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.22,					-- Anti Air Gun Damage factor
...
NAI = {
	...
	AIR_MISSION_MIN_COVEREAGE = 0.3,			-- Between 0 and 1, limit for % coverage for air mission to be considered
	...
	UPGRADE_DIVISION_RELUCTANCE = 4.5,					-- How often to consider upgrading to new templates for units in the field
	...
	UPGRADES_DEFICIT_LIMIT_DAYS = 190,                           -- Ai will avoid upgrading units in the field to new templates if it takes longer than this to fullfill their equipment need
