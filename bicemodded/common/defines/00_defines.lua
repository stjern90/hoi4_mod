...
NCountry = {
	...
	VP_TO_SUPPLY_BONUS_CONVERSION = 0.9,			-- Bonus to supply local supplies from Victory Points, multiplied by this aspect and rounded to closest integer
...
NProduction = {
	...
	EQUIPMENT_MODULE_REMOVE_XP_COST = 3.0,				-- XP cost for removing an equipment module and leaving the slot empty when creating an equipment variant.
	...
	MIN_NAVAL_EQUIPMENT_CONVERSION_RESOURCE_COST_FACTOR = 0.6,	-- Minimum fraction of an equipment type's base strategic resource cost to use when converting a naval equipment, such as through ship refitting.
...
NMilitary = {
	...
	ALERT_VERY_LOW_SUPPLY_LEVEL = 0.50,			   -- At which point we show up the low and very low supply level alert. Value is in % of supplies supported vs required.
	...
	COMBAT_SUPPLY_LACK_IMPACT = -0.45,				-- combat penalty if out of supply
	...
	FUEL_EFFICIENCY_RAID_MULTIPLIER = 2.0,			-- convoy raid multiplier for fuel sunk
...
NAir = {
	...
	NAVAL_STRIKE_BASE_STR_TO_PLANES_RATIO = 0.21,		-- Max airbombers to do port strike comparing to strength
	...
	NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO_PER_DAY = 0.25, -- max extra plane % that can join every day
	...
	NAVAL_MINES_PLANTING_SPEED_MULT = 0.005,						-- Value used to overall balance of the speed of planting naval mines
	NAVAL_MINES_SWEEPING_SPEED_MULT = 0.008,						-- Value used to overall balance of the speed of sweeping naval mines
...
NAI = {
	...
	REFIT_SHIP_RELUCTANCE = 5,							-- How often to consider refitting to new equipment variants for ships in the field
	...
	ORDER_ASSIGNMENT_DISTANCE_FACTOR = 4.0,			-- When the AI assigns units to orders, it attempts to calculate the distance.
	...
	MAX_UNIT_RATIO_FOR_INVASIONS = 0.35,							-- countries won't use armies more than this ratio of total units for invasions
