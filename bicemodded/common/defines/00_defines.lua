...
NCountry = {
	...
	CONVOY_RANGE_FACTOR = 0.75,                        -- how much range affects convoy need
...
NProduction = {
	...
	BASE_FACTORY_SPEED_MIL = 4.4, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
