...
NAir = {
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 1.2,					-- Balancing value to convert damage ( naval_strike_attack * hits ) to Strength reduction.
	NAVAL_STRIKE_DAMAGE_TO_ORG = 0.82,					-- Balancing value to convert damage ( naval_strike_attack * hits ) to Organisation reduction.
