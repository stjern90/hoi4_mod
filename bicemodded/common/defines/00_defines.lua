...
NTechnology = {
	...
	BASE_YEAR_AHEAD_PENALTY_FACTOR = 2.4,		-- 3 Base year ahead penalty
...
NMilitary = {
	...
	BASE_NIGHT_ATTACK_PENALTY = -0.65,
...
NNavy = {
	...
	COMBAT_LOW_ORG_HIT_CHANCE_PENALTY = -0.7,						-- % of penalty applied to hit chance when ORG is very low.
	...
	COMBAT_DAMAGE_TO_STR_FACTOR = 1.5,								-- casting damage value to ship strength multiplier. Use it to balance the game difficulty.
	...
	ENEMY_AIR_SUPERIORITY_IMPACT = -0.55,           					-- effect on ship efficiency due to enemy air superiorty
...
NAI = {
	...
	SEND_VOLUNTEER_EVAL_MAJOER_POWER = 1.2, 	-- How willing major powers are to send volunteers.
