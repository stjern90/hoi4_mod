...
NAI = {
	...
	VARIANT_UPGRADE_MIN_XP = 130,				-- Minimum XP before attempting to create a new variant.
	UPGRADE_XP_RUSH_UPDATE = 190,				-- If XP is above this on the daily tick the AI will attempt to spend it
