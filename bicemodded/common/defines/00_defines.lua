...
NProduction = {
	...
	MAX_LINE_RESOURCE_PENALTY = 65,		-- Max penalty factor for production lines lacking strategic resources in %.
...
NBuildings = {
	...
	NAVALBASE_REPAIR_MULT = 0.1,		-- Each level of navalbase building repairs X strength. The value is spread on all ships needed reparation. Fe Navalbase lvl 5 x 0.5 str repair = 2.5 str repaired over 10 ships, so each ship repair hourly 0.25 str.
...
NAI = {
	...
	MIN_ANTAGONIZE_FOR_WARGOAL_JUSTIFICATION = 50,	-- AI countries will not fabricate claims against countries with an antagonization value lower than this.
