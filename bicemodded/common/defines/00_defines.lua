...
NDiplomacy = {
	...
	VICTORY_POINT_WORTH_FACTOR = 55,				-- multiplier when calcualting proince worth (surrender)
...
NMilitary = {
	...
	PLANNING_DECAY = 0.01,
	PLANNING_GAIN = 0.03,
	PLANNING_MAX = 0.35,                           	-- can get more from techs
...
NAI = {
	...
	TRADEABLE_FACTORIES_FRACTION = 0.85,			-- Will at most trade away this fraction of factories.
	...
	PRODUCTION_MAX_PROGRESS_TTO_SWITCH_NAVAL = 1.2,		-- AI will not replace ships being built by newer types if progress is above this
