...
NAir = {
	...
	NAVAL_STRIKE_DAMAGE_TO_ORG = 1.54,					-- Balancing value to convert damage ( naval_strike_attack * hits ) to Organisation reduction.
...
NNavy = {
	...
	COMBAT_TORPEDO_CRITICAL_DAMAGE_MULT = 2.5,						-- multiplier to damage when got critical hit from torpedo. (Critical hits are devastating as usualy torpedo_attack are pretty high base values).
	...
	SUBMARINE_BASE_TORPEDO_REVEAL_CHANCE 							= 0.11,		-- Chance of a submarine being revealed when it fires. 1.0 is 100%. this chance is then multiplied with modifier created by comparing firer's visibiility and target's detection
...
NSupply = {
	...
	CAPITAL_SUPPLY_BASE = 3.0, -- base supply for capital
