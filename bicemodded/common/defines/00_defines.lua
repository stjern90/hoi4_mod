...
NNavy = {
	...
	AMPHIBIOUS_LANDING_PENALTY = -0.9,								-- amphibious landing penalty
...
NAI = {
	...
	PLAN_VALUE_TO_EXECUTE = -0.65,				-- AI will typically avoid carrying out a plan it below this value (0.0 is considered balanced).
