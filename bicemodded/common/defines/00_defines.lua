...
NSupply = {
	...
	CAPITAL_SUPPLY_CIVILIAN_FACTORIES = 0.25, -- supply from one civilian factory
	CAPITAL_SUPPLY_MILITARY_FACTORIES = 0.35, -- supply from one military factory
	...
	NAVAL_BASE_FLOW = 7.5, -- max output/input of a naval node is limited by this base value + additional ratio for each level
	NAVAL_FLOW_PER_LEVEL = 2.5, -- max output/input of a naval node is limited by previous base value + this define per its level
