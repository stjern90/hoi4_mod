...
NAI = {
	...
	DEPLOY_MIN_EQUIPMENT_WAR_FACTOR = 0.8,		-- Required percentage of equipment (1.0 = 100%) for AI to deploy unit in wartime
	...
	STR_BOMB_FIGHTERS_PER_PLANE = 0.6,					-- Amount of air superiority planes requested per enemy plane
