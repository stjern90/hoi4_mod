...
NGraphics = {
	...
	MAP_ICONS_GROUP_CAM_DISTANCE = 130.0, -- camera distance at which the icons begin to group up
	MAP_ICONS_STATE_GROUP_CAM_DISTANCE = 325.0, -- Camera distance at which the icons begin to group up on state level
	MAP_ICONS_STRATEGIC_GROUP_CAM_DISTANCE = 400, -- second camera distance at which the icons begin to group up
