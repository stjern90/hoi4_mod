...
NGraphics = {
	...
	VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = {180, 360, 500},  -- At what camera distance the VP name text disappears.
	VICTORY_POINTS_DISTANCE_CUTOFF = {300, 500, 900}, -- At what distance VPs are hidden
	...
	MAP_ICONS_GROUP_CAM_DISTANCE = 235.0, -- camera distance at which the icons begin to group up
	MAP_ICONS_STATE_GROUP_CAM_DISTANCE = 400.0, -- Camera distance at which the icons begin to group up on state level
	MAP_ICONS_STRATEGIC_GROUP_CAM_DISTANCE = 600.0, -- second camera distance at which the icons begin to group up
