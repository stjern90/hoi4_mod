...
NGraphics = {
	...
	VICTORY_POINTS_DISTANCE_CUTOFF = {300, 500, 1000}, -- At what distance VPs are hidden
	...
	MAP_ICONS_STATE_GROUP_CAM_DISTANCE = 525.0, -- Camera distance at which the icons begin to group up on state level
	MAP_ICONS_STRATEGIC_GROUP_CAM_DISTANCE = 750, -- second camera distance at which the icons begin to group up
