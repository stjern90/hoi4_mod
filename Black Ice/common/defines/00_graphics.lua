...
NMapIcons = {
	...
	STRATEGIC_NAVY_PRIORITY_CAPITAL = 50,
	...
	RESISTANCE_PRIORITY_CAPITAL = 50,
	...
	STRATEGIC_REGIONS_PRIORITY_CAPITAL = 50,
	...
	DEPLOYMENT_AIR_PRIORITY_CAPITAL = 50,
	...
	DEPLOYMENT_NAVY_PRIORITY_CAPITAL = 50,
	...
	DEPLOYMENT_MILITARY_PRIORITY_CAPITAL = 50,
	...
	PEACE_CONFERENCE_PRIORITY_CAPITAL = 50,
	...
	INFRASTRUCTURE_PRIORITY_CAPITAL = 50,
	...
	DIPLOMACY_FABRICATE_CLAIM_PRIORITY_CAPITAL = 50,
	...
	START_CONSTRUCTION_PRIORITY_CAPITAL = 50,
...
NGraphics = {
	...
	PROVINCE_NAME_DRAW_DISTANCE = 300.0, 			-- Remove province names beyond this distance
	...
	LIGHT_HDR_RANGE = 1.0,
	BORDER_WIDTH = 1.2,
	PROVINCE_BORDER_FADE_NEAR = 125,
	PROVINCE_BORDER_FADE_FAR = 200,
	STATE_BORDER_FADE_NEAR = 350,
	...
	BORDER_COLOR_SELECTION_SUPPLY_AREA_R = 70.0,
	BORDER_COLOR_SELECTION_SUPPLY_AREA_G = 225.0,
	BORDER_COLOR_SELECTION_SUPPLY_AREA_B = 225.,
	...
	BORDER_COLOR_SELECTION_PROVINCE_G = 120.0,
	...
	GRADIENT_BORDERS_THICKNESS_SUPPLY_AREA_A = 2.5,	-- 2.0
	GRADIENT_BORDERS_THICKNESS_SUPPLY_AREA_B = 9.0,	-- 20.0
	GRADIENT_BORDERS_THICKNESS_STRATEGIC_REGIONS = 11.0, --80
	...
	VICTORY_POINT_MAP_ICON_AFTER = {0, 15, 30}, -- VP levels dependent. After this amount of VP the map icon becomes bigger dot.
	VICTORY_POINT_MAP_ICON_TEXT_CUTOFF = {100, 200, 400, 1000},  -- 200, 500, 1000 --At what camera distance the VP name text disappears.
	VICTORY_POINTS_DISTANCE_CUTOFF = {95, 195, 395, 995}, -- At what distance VPs are hidden
	AIRBASE_ICON_DISTANCE_CUTOFF = 800, -- At what distance air bases are hidden
	NAVALBASE_ICON_DISTANCE_CUTOFF = 800, -- 1200 --At what distance naval bases are hidden
	...
	MAP_ICONS_GROUP_CAM_DISTANCE = 250.0, -- 100 camera distance at which the icons begin to group up
	MAP_ICONS_STATE_GROUP_CAM_DISTANCE = 450.0, -- 225 Camera distance at which the icons begin to group up on state level
	MAP_ICONS_STRATEGIC_GROUP_CAM_DISTANCE = 750, -- 375 second camera distance at which the icons begin to group up
	...
	CAMERA_OUTSIDE_MAP_DISTANCE_BOTTOM = 100.0,
	...
	POLITICAL_GRID_SMALL_BOX_LIMIT = 19,              	-- Limit for gridbox in political view before it will be replaced with extended gridbox
